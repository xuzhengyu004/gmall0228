...
public class SkuInfo implements Serializable {
    ...
    public SkuInfo(String spuId, BigDecimal price, String skuName, BigDecimal weight, String skuDesc, String catalog3Id, String skuDefaultImg, List<SkuImage> skuImageList, List<SkuAttrValue> skuAttrValueList, List<SkuSaleAttrValue> skuSaleAttrValueList) {
        this.spuId = spuId;
        this.price = price;
