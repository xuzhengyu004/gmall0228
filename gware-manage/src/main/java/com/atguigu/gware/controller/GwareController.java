...
//    @RequestMapping(value="updateStockStat",method = RequestMethod.GET)
//    @ResponseBody
//    public String updateStockStat(WareOrderTask wareOrderTask){
//        wareOrderTask.setTaskStatus(TaskStatus.DEDUCTED);
//       // gwareService.lockStock(wareOrderTask);
//        return "update Stock Stat success";
//    }
